...
class FavoriteControllerTest {
    ...
    void POST_favorite_비로그인_찜목록_생성() throws Exception {
        ...
        List<FavoriteListNonLoginResponse> stubResponse = List.of(
                new FavoriteListNonLoginResponse(1L, "식당C", "주소C", 33.3, 333.3),
                new FavoriteListNonLoginResponse(2L, "식당A", "주소A", 11.1, 111.1),
                new FavoriteListNonLoginResponse(3L, "식당B", "주소B", 22.2, 222.2)
        );
